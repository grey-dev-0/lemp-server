<div vue-template>
    ...
    <div class="btn btn-sm btn-outline-danger" title="Delete project {{$project->path}}" @click="remove"><font-awesome-icon icon="far fa-trash-alt" size="lg"></font-awesome-icon></div>
</div>